...
export function Sider() {
    ...
    return (
        <AntdSlider theme="light" className="px-[30px] py-[20px] w-[300px] relative overflow-hidden" width={300}>
            <div className="flex items-center justify-start gap-5">
                <img src="/SiderWomanImg.svg" alt="Woman Img" />
                <div>
                    <Typography className="!m-0 !font-[900] text-[16px] !font-[Poppins]">Jamila Azimova</Typography>
