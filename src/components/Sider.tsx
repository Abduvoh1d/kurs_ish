                ...
                <div>
                    {data.map((item, index) => (
                        <Link to={item.link} key={index}
                              className={`flex justify-start items-center gap-3 font-[Poppins] font-[600] px-[20px] py-[15px] ${location.pathname.includes(item.link) ? 'bg-[#635AD9] text-white hover:text-white' : 'hover:text-black'} rounded-xl cursor-pointer`}>
